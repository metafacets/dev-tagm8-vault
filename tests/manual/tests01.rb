...
Debug.show(note:1,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Tag.add_tags([:cat, :dog], :mammal)
Debug.show(note:2,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Tag.add_tag(:animal, :life)
Debug.show(note:3,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Tag.add_tag(:life, :dog)
Debug.show(note:4,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Tag.add_tag(:mammal, :animal)
Debug.show(note:5,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Tag.add_tags([:fish, :insect], :animal)
Tag.add_tags([:carp, :herring], :fish)
Tag.add_tag(:carp, :food)
Tag.add_tag(:carpette, :carp)
Debug.show(note:6,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
...
Debug.show(note:7,tags:[:test],vars:[['tags',Tag.tags],['roots',Tag.roots],['folks',Tag.folksonomy]])
Debug.show(tags:[:test],level:4,vars:[['descendents',Tag.get_tag(:animal).get_descendents]])
